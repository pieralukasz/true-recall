...
export function StudyNowButton({ dueCount }: { dueCount: number }) {
	...
	return (
		<div class="ep:mb-4">
			<Clickable
				class="ep:w-full ep:py-3 ep:px-6 ep:rounded-lg ep:bg-obs-interactive ep:text-obs-on-interactive ep:text-center ep:font-semibold ep:text-base ep:transition-all ep:duration-200 ep:hover:opacity-90"
				onClick={handleStudy}
			>
