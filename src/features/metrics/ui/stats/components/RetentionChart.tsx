...
export function RetentionChart({ data, targetRetention = 90 }: RetentionChartProps) {
	...
	if (data.length === 0) {
		return (
			<ChartCard title="Retention" subtitle="Daily correct answer rate">
				<p class="ep:text-xs ep:text-obs-muted ep:py-8 ep:text-center">No retention data yet</p>
			</ChartCard>
		);
	}
	...
	return (
		<ChartCard title="Retention" subtitle={`Average: ${avg}% — Target: ${targetRetention}%`}>
			<div class="ep:h-48">
