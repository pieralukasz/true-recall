...
export const ALL_COLUMNS = [
    ...
    },
    {
        ...
        accessor: (c) => {
            ...
            if (c.buriedUntil && new Date(c.buriedUntil) > new Date())
                return "Buried";
            return (_a = STATE_LABELS[c.state]) !== null && _a !== void 0 ? _a : "Unknown";
        },
    },
    {
        key: "due",
    ...
    },
    {
        ...
        defaultVisible: true,
        align: "left",
        accessor: (c) => { var _a; return (_a = c.sourceNoteName) !== null && _a !== void 0 ? _a : "(orphaned)"; },
    },
    {
        key: "reps",
        label: "Reps",
    ...
    },
    {
        ...
        defaultVisible: false,
        align: "right",
        accessor: (c) => c.lastReview ? formatRelativeDate(c.lastReview) : "never",
    },
    {
        key: "cardType",
        label: "Type",
    ...
    },
    {
        ...
        defaultVisible: false,
        align: "center",
        accessor: (c) => { var _a; return (_a = c.createdVia) !== null && _a !== void 0 ? _a : "manual"; },
    },
    {
        key: "preset",
        label: "Preset",
        ...
        defaultVisible: false,
        align: "left",
        accessor: (c) => { var _a; return (_a = c.presetName) !== null && _a !== void 0 ? _a : "Default"; },
    },
];
