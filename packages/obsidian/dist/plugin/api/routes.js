...
import { handleBulkBury, handleBulkDelete, handleBulkSuspend, handleDeleteCard, handleRemoveCardsFromNote, handleSuspendCard, handleUpdateCard, } from "./handlers/card-actions";
import { handleGetCardContext } from "./handlers/card-context";
import { handleGetCardRelations } from "./handlers/card-relations";
import { handleCreateCards, handleGetCard, handleGetDueCards, handleGetProblemCards, handleListCards, } from "./handlers/cards";
import { handleGetDashboard, handleGetProject, handleGetProjects, } from "./handlers/dashboard";
...
import { handleAddFlashcardUid, handleSetArchive, handleSetParent, handleSetPresetForNote, } from "./handlers/notes";
import { handleGetSchema, handleQuerySql } from "./handlers/query";
import { handleRagIndex, handleRagSearch, handleRagStatus, } from "./handlers/rag";
import { handleGradeCard } from "./handlers/review";
import { handleGradeSessionCard, handleRevealAnswer, } from "./handlers/review-actions";
...
import { handleGetDailyStats, handleGetPatterns, handleGetSummary, } from "./handlers/stats";
...
export function dispatch(req, res, ctx) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b;
        const method = (_a = req.method) !== null && _a !== void 0 ? _a : "GET";
        const urlObj = new URL((_b = req.url) !== null && _b !== void 0 ? _b : "/", "http://localhost");
        const pathname = urlObj.pathname;
        if (method === "OPTIONS") {
            res.writeHead(204, Object.assign(Object.assign({}, CORS_HEADERS), { "Access-Control-Max-Age": "86400" }));
            res.end();
            return;
        }
        for (const r of routes) {
            ...
            r.paramNames.forEach((name, i) => {
                var _a;
                params[name] = (_a = match[i + 1]) !== null && _a !== void 0 ? _a : "";
            });
            try {
                yield r.handler(req, res, ctx, params);
            }
            catch (error) {
