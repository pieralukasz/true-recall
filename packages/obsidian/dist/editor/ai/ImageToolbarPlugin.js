...
function extractImagePathFromClick(target, view) {
...
export function createImageToolbarExtension(callbacks) {
    return ViewPlugin.fromClass(class {
        constructor(view) {
            ...
            this.handleClick = (e) => {
                ...
                if (this.container && this.currentImagePath === imagePath)
                    return;
        ...
        showToolbar(imagePath, imgEl) {
            ...
            render(h(ImageToolbar, {
                imagePath,
                onQuickAdd: () => __awaiter(this, void 0, void 0, function* () {
                    yield callbacks.onQuickAddImage(imagePath);
                }),
