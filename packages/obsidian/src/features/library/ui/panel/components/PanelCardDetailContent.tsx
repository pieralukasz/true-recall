...
import { PanelFactCheckSection } from "@true-recall/obsidian/features/library/ui/panel/components/PanelFactCheckSection";
...
export function PanelCardFields({
	...
	return (
		<>
			...
			{fsrsCard ? <PanelFactCheckSection card={fsrsCard} /> : null}
		</>
	);
}
