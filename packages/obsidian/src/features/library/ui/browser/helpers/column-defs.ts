...
export const ALL_COLUMNS: ColumnDef[] = [
	...
	},
	{
		key: "edits",
		label: "Edits",
		sqlColumn: "edit_count",
		width: "60px",
		sortable: true,
		defaultVisible: false,
		align: "right",
		accessor: (c) => String(c.editCount),
	},
	{
		key: "aiEdits",
		label: "AI Edits",
		sqlColumn: "ai_edit_count",
		width: "70px",
		sortable: true,
		defaultVisible: false,
		align: "right",
		accessor: (c) => String(c.aiEditCount),
	},
	{
		key: "lastEdited",
		label: "Last Edited",
		sqlColumn: "content_edited_at",
		width: "90px",
		sortable: true,
		defaultVisible: false,
		align: "right",
		accessor: (c) => formatTimestamp(c.contentEditedAt),
	},
	{
		key: "preset",
		label: "Preset",
