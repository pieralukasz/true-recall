import type { CardsCreatedEntry, ExtendedDailyStats } from "@true-recall/core/types";
...
export function CreatedVsReviewedChart({
	...
	const reviewMap = new Map(
		reviewHistory.map((d) => [d.date, d.reviewsCompleted]),
	);
	...
	return (
		<ChartCard
			...
			subtitle="Card creation compared to review activity"
		>
			<div class="ep:h-48">
