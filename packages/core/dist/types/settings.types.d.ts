 ...
 */
export type ReviewOrder = "due-date" | "random" | "due-date-random" | "by-retrievability" | "most-lapses" | "relative-overdueness" | "lowest-stability" | "order-added";
/**
 ...
 */
export declare function extractFSRSSettings(settings: TrueRecallSettings): FSRSSettings;
export declare function extractFSRSSettingsFromPreset(preset: FSRSPreset): FSRSSettings;
