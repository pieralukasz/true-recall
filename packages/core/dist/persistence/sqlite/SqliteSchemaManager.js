...
export class SqliteSchemaManager {
    ...
    createFts5() {
        try {
            ...
            this.db.run(`INSERT OR REPLACE INTO meta (key, value) VALUES ('fts5_available', '1')`);
        }
        catch (e) {
            console.warn("[True Recall] FTS5 setup failed — falling back to LIKE queries.", e);
            this.db.run(`INSERT OR REPLACE INTO meta (key, value) VALUES ('fts5_available', '0')`);
        }
    }
}
